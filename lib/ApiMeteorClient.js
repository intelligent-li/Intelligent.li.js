...
(function(root) {
  ...
  var ili = root.ili,
      ...
      uuid = ili.importPackage(root, 'uuid', 'uuid'),
  ...
  function Api(host) {
    ...
    this.initialise = function() {
      logger.info("this._clientId: "  + this._clientId);
      this._sampleStream = new Meteor.Stream('ili.samples');
    }

    //
    // Loads the samples for the given range
...
Meteor.startup(function() {
  Meteor.call('keepalive', ili.Api.instance._clientId);
